...
class Goglemaps {
	...
	var $apiKey						= 'AIzaSyA3UCSLzC5UJE-iuBU1GPQF77fvAsG4wIs'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function add_marker($params = array())
	{
		...
		$marker['icon'] = 'http://bestbuilding.ge/assetss/images/123.png';									// The name or url of the icon to use for the marker
		$marker['icon_size'] = '100,80';								// The display size of the sprite or image being used. When using sprites, you must specify the sprite size. Expecting two comma-separated values for width and height respectively (ie '20,30'). See https://developers.google.com/maps/documentation/javascript/3.exp/reference#Icon
		$marker['icon_scaledSize'] = '100,80';						// The size of the entire image after scaling, if any. Use this property to stretch/shrink an image or a sprite. Expecting two comma-separated values for width and height respectively (ie '20,30')
