    ...
    <ul class="email-media-list" >
      ...
      <li class="d-flex user-mail" style="border-bottom:1px solid black;border-top:1px solid #f1d766;<?php if($sms_item['status'] == 0) echo'background:#605656!important;';?>">
        <div class="mail-left pe-50">
          <div class="avatar">
            <a href="<?=base_url('admin/brigadiri_migebuli_sms_details/');?><?php echo $sms_item['code']; ?>"><img src="<?=base_url();?>assets/admin/images/users/user.jpg" alt=""></a>
          </div>
        </div>
        <div class="mail-body">
          <div class="mail-details">
            <div class="mail-items">
             <h5 class="mb-25"><a href="<?=base_url('admin/brigadiri_migebuli_sms_details/');?><?php echo $sms_item['code']; ?>" style="color:black;">&#160&#160 <?php echo $sms_item['reg_name'].' '.$sms_item['reg_surname']; ?></a></h5>
            </div>
