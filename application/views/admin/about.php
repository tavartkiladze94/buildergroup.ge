				...
				<div class="in-content-wrapper">
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								<div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="<?=base_url('admin/index')?>"><?=$this->lang->line('Control panel');?></a>
								</div>
					...
					<div class="box" id="info_block" >
						...
						<div class="hotel-listing-form" id="details_form">
							<form  action="<?=base_url('admin/about_update')?>" method="POST">
