...
$("#migebuli_pasuxi").click(function(){
      ...
      document.getElementById("mimgebi").value="<?php echo $iuridiuli_sms_details['reg_name'].'-'.$iuridiuli_sms_details['reg_surname'];?>";
   ...
   <div class="app-action">
    <div class="action-left">
      <div class="form-check selectAll">
        ...
        <label class="form-check-label fw-bolder ps-25" style="font-size:16px;"><b><?php echo $iuridiuli_sms_details['reg_name'].' '.$iuridiuli_sms_details['reg_surname'];?></b></label>
