...
$(document).ready(function(){
 ...
 $("#axali_shetyobineba_close").click(function(){
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">ბრიგადირები: - <?php echo $satauri;?></h2>
  ...
  <form class="forma-content" action="<?=base_url('admin/brigadiris_sms_gagzavna/');?><?php echo $code;?>" method="POST" style="background:#444041!important;">
    <div class="container" >
      ...
      <label for="object"><b>მიმღები</b></label>
       <select class="form-control" id="mimgebi" name="mimgebi" id="mimgebi" style="max-height:300px;"  requred >
                      <option></option>
                <?php if (!empty($brigadiri_users_all_select)) foreach ($brigadiri_users_all_select as $users_item_select): ?>
  ...
  <div class="card" style="height:140px; padding:0;margin:0;">
        ...
        <div class="card-body" style="padding:2px; margin:0;">
          ...
          <form action="<?=base_url('admin/update_brigadiri_gallery/');?><?php echo $code;?>" class="dropzone dropzone-area" id="dpz-btn-select-files" style="min-height:100px;max-height:140px; margin:0;">
    ...
    <div class="col-12">
      <div class="card" style="margin-bottom:0;">
        ...
        <div class="card-body mt-2">
          <form class="text-center" action="<?=base_url('admin/brigadiri_all_search')?>" method="POST">
            <div class="row">
...
<div class="content-overlay"></div>
    ...
    <div class="sidebar-menu-list ps ps--active-y">
      <div class="list-group list-group-messages">
        <a href="<?=base_url('admin/brigadiri_migebuli');?>" class="list-group-item list-group-item-action" style="background:#373334!important;">
        ...
        <a href="<?=base_url('admin/brigadiri_gagzavnili');?>" class="list-group-item list-group-item-action" style="background:#373334!important;">
        ...
        <a href="<?=base_url('admin/brigadiri_files');?>" class="list-group-item list-group-item-action" style="background:#373334!important;">
