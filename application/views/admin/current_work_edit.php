				...
				<div class="in-content-wrapper">
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								<div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="<?=base_url('admin/object_edit/')?><?php echo $current_work_edit['object_code'] ;?> "><?=$this->lang->line('All');?></a>
								</div>
					...
					<div class="box" id="apart_menu" style="display:block;">
							...
							<div class="col text-left">
								<div class="add-new">
									<a href="<?=base_url('admin/current_work_create/');?><?php echo $current_work_edit['object_code'] ;?>"><?=$this->lang->line('Add new');?><i class="fas fa-plus"></i></a>
								</div><!-- End add-new-->
							</div><!-- End column-->
					...
					<div class="box"  >
						...
						<div class="hotel-listing-form" id="details_form">
							<form  action="<?=base_url('admin/current_work_update/')?><?php echo $current_work_edit['code'];?>" method="POST" >
...
<h1 style="color:black;"> რედაქტირება - <?php echo $current_work_edit['date'] ;?> </h1>
	...
	<textarea name="full_text_en" class="jqte-test"><b><?php echo $current_work_edit['full_text_en'];?></b></textarea>
                         ...
                         <div class="hotel-listing-form">
                             <div action="<?=base_url('admin/update_current_work_gallery/')?><?php echo $current_work_edit['code'];?>/<?php echo $current_work_edit['object_code'];?>" class="dropzone needsclick dz-clickable" id="demo-upload">
...
<div class="container" >
  ...
  <div class="dropdown-content">
      <a href="<?=base_url('admin/set_as_current_work_main_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Set as main');?></a>
      <a href="<?=base_url('admin/delete_current_work_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Delete');?></a>
