...
<section id="basic-input" >
    <form class="text-center" action="<?=base_url('admin/object_problem_create/')?><?php echo $object;?>" method="POST">
            ...
            <div class="col-xl-4 col-md-6 col-12 mb-1" style="width:100%; max-width:100%;">
              <div class="form-group">
                ...
                <select class="form-control" id="object" name="object">
                             ...
                             <option  value="<?php echo $object; ?>" ><?=$this->lang->line($object);?></option>
