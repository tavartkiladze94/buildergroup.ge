    ...
    <ul class="email-media-list" >
      ...
      <li class="d-flex user-mail" style="padding:2px;border-top:1px solid black;<?php if($sms_item['status'] == 0) echo 'background-color:silver;';?>">
        <div class="mail-left pe-50">
          <div class="avatar">
           <a href="#"> <img style="border-radius: 0;" src="<?=base_url();?>assets/images/<?php if($sms_item['file_ext'] == '.jpg' || $sms_item['file_ext']== '.jpeg' || $sms_item['file_ext']=='.png') echo 'brigadiri/'.$sms_item['file_name']; else{ echo strtolower($sms_item['file_ext']).'.png';} ?>" alt="">
          </a>
          </div>
        </div>
        <div class="mail-body" >
          <div class="mail-details">
            <div class="mail-items" >
              <h5 class="mb-25" style=" margin-left:5px; text-align:left!important;font-size:15px!important;"><b><?php echo $sms_item['file_name']; ?> - <a href="<?=base_url();?>assets/images/brigadiri/<?php echo $sms_item['file_name']; ?>" download style="background-color:#7367F0!important; ">ჩამოტვირთვა</a> </b></h5>  
            </div>
