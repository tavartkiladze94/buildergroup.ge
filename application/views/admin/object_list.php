					...
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								...
								<div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="<?=base_url('admin/object_list');?>"><?=$this->lang->line('All');?></a>
								</div>
							...
							<div class="dataTables_length" id="example_length" style="width:100%;">
								...
								<table id="example" class="display table-hover table-responsive-xl listing dataTable no-footer" role="grid" aria-describedby="example_info" >
									...
									<tr role="row" class="odd" style="width:100%; height:70px;">
											<td class="sorting_1" ><img src="<?=base_url('assetss/images/projects/');?><?php echo $object_item['file_name']; ?>" alt="<?=$this->lang->line('Photo');?>" class="img-fluid rounded-circle" width="40px" style="max-height:70px;"></td>
											<td ><a href="<?=base_url('admin/object_edit/');?><?php echo $object_item['code']; ?>" style="color:#007bff;"><?php echo $object_item['title_ge']; ?></a></td>
											<td ><a href="<?=base_url('admin/object_edit/');?><?php echo $object_item['code']; ?>" style="color:#007bff;"><?php echo $this->lang->line($object_item['type']); ?></a></td>
											<td ><a href="<?=base_url('admin/object_edit/');?><?php echo $object_item['code']; ?>" style="color:#007bff;"><?php echo $object_item[$this->lang->line('project_address_lang')] ; ?></a></td>
