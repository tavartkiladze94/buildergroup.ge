                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-4">
                            <div class="breadcrumb">
                                <div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="<?=base_url('redaqtor/apartment_all');?>/<?=$this->session->userdata('id')?>"><?=$this->lang->line('Apartment');?></a>
                                </div>
                    ...
                    <div class="box">
                        <div class="hotel-listing-form">
                            <form class="text-center" method="POST">
                                ...
                                <div action="<?=base_url('redaqtor/update_apartment_gallery/')?><?php echo $cod; ?>" class="dropzone needsclick dz-clickable" id="demo-upload">
...
<div class="container" >
  ...
  <div class="dropdown-content">
      <a href="<?=base_url('redaqtor/set_as_apartment_main_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Set as main');?></a>
      <a href="<?=base_url('redaqtor/delete_apartment_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Delete');?></a>
