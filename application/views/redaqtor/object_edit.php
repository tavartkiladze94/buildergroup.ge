...
$(document).ready(function(){
  ...
  $("#example").DataTable();
  alert("<?php echo $this->session->userdata('object_edit_block');?>");
});
</script>
		<!-- ===========Innerpage-wrapper============= -->
		<section>
				...
				<div class="in-content-wrapper">
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								...
								<div class="breadcrumb-item active"><i class="fas fa-angle-right"></i><?php echo $this->lang->line($object_edit['object']) ;?> 
								</div>
							</div><!-- end breadcrumb-->
						</div><!-- end column -->
					...
					<div class="box" id="apart_menu" style="display:block;">
							...
							<div class="col text-left">
								<div class="add-new">
									<a href="<?=base_url('redaqtor/object_create');?>"><?=$this->lang->line('Add new');?><i class="fas fa-plus"></i></a>
								</div><!-- End add-new-->
							</div><!-- End column-->
					...
					<div class="box" id="info_block" >
					 	<div class="hotel-listing-form" >
							<form  action="<?=base_url('redaqtor/object_update/')?><?php echo $object_edit['code'];?>" method="POST" >
	...
	<button type="submit" class="testbutton"><?=$this->lang->line('Save');?></button>
                        ...
                        <div class="hotel-listing-form">
                            <form class="text-center" method="POST">
                                ...
                                <div action="<?=base_url('redaqtor/update_object_gallery/')?><?php echo $object_edit['code'];?>" class="dropzone needsclick dz-clickable" id="demo-upload">
...
<div class="container" >
  ...
  <div class="dropdown-content">
      <a href="<?=base_url('redaqtor/set_as_object_main_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Set as main');?></a>
      <a href="<?=base_url('redaqtor/delete_object_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Delete');?></a>
    ...
    <img src="<?=base_url();?>assets/images/projects/<?php echo $images_item['file_name']; ?>" style=" max-width:100%;max-height:400px;" >
  </div>
  <?php $raod++; ?>
<?php endforeach; ?>
  ...
  <div class="row">
    ...
    <div class="column">
      <img class="demo cursor" src="<?=base_url();?>assets/images/projects/<?php echo $imagess_item['file_name']; ?>" style="width:100%;max-height:80px;" onclick="currentSlide(<?php echo $raode; ?>)">
    </div>
   <?php $raode++; ?>
<?php endforeach; ?>
</div>
                 ...
                 <div class="box" id="current_work_block" >
						<div class="row no-gutters">
							<div class="col text-left">
								<div class="add-new">
									<a href="<?=base_url('redaqtor/current_work_create/');?><?php echo $object_edit['code'];?>">მიმდინარე სამუშაოს დამატება<i class="fas fa-plus"></i></a>
								</div><!-- End add-new-->
							</div><!-- End column-->
							...
							<div class="dataTables_length" id="example_length" style="width:100%;">
								...
								<table id="example" class="display table-hover table-responsive-xl listing dataTable no-footer" role="grid" aria-describedby="example_info" >
									...
									<tr role="row" class="odd" style="width:100%; height:70px; ">
											...
											<td ><a href="<?=base_url('redaqtor/current_work_edit/');?><?php echo $current_work_item['code']; ?>" style="color:#007bff;"><?php echo $current_work_item['date']; ?></a></td>
											<td ><a href="<?=base_url('redaqtor/current_work_edit/');?><?php echo $current_work_item['code']; ?>" style="color:#007bff;"><?php echo $current_work_item['reg_name'] ; ?> <?php echo $current_work_item['reg_surname'] ; ?></a></td>
											<td ><a href="<?=base_url('redaqtor/current_work_delete/');?><?php echo $current_work_item['code']; ?>/<?php echo $current_work_item['object_code']; ?>" style="color:red;"><?php echo $this->lang->line('Delete') ; ?></a></td>
