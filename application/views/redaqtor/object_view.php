			...
			<div class="content add-details">
				<div class="in-content-wrapper">
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								<div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="<?=base_url('redaqtor/apartment_list')?>/<?=$this->session->userdata('id')?>"><?=$this->lang->line('All');?></a>
								</div>
					...
					<div class="box" id="info_block" >
					    ...
					    <a href="<?=base_url('redaqtor/apartment_activate1/');?><?php echo $apartment_view['code']; ?>/<?php echo $apartment_view['id']; ?>"><button class="button"><?=$this->lang->line('Activate');?></button></a>
					    <a href="<?=base_url('redaqtor/apartment_expired/');?><?php echo $apartment_view['code']; ?>/<?php echo $apartment_view['id']; ?>"><button class="button" style="background-color:#f44336;"><?=$this->lang->line('Expire');?></button></a>
				    	</div>
						<div class="hotel-listing-form" id="details_form">
							<form class="text-center" action="<?=base_url('redaqtor/apartment_view_update/');?><?php echo $apartment_view['code']; ?>" method="POST">
							       <div class="form-row">
									<div class="col-md">
								...
								<div class="form-row" id="user_info3">
									<div class="col-md">
										<div class="form-group" >
										  <textarea class="form-control" rows="4" cols="80" style="margin-top:0;padding-left:1px;" name="admin_comment" id="admin_comment" ><?php echo $apartment_view['redaqtor_comment'];?></textarea>
										</div><!-- end form-group -->
									</div><!-- end column -->
									<div class="col-md" style="text-align: left; ">
...
function showSlides(n) {
  ...
  captionText.innerHTML = dots[slideIndex-1].alt;
      ...
      function ganaxleba()
      {
          location.href = "<?=base_url('redaqtor/update_coords/');?><?php echo $apartment_view['code'];?>"+"/"+latt+"/"+lngg;
