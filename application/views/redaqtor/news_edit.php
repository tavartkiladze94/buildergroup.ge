...
$(document).ready(function(){
   $("#<?=$this->session->userdata('news_edit_block');?>").css("display", "block");
  $("#info").click(function(){
				...
				<div class="in-content-wrapper">
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								...
								<div class="breadcrumb-item active"><i class="fas fa-angle-right"></i><?php echo $this->lang->line('Title') ;?> 
								</div>
							</div><!-- end breadcrumb-->
						</div><!-- end column -->
					...
					<div class="box" id="info_block" >
						...
						<div class="hotel-listing-form" id="details_form">
							<form  action="<?=base_url('redaqtor/news_update/')?><?php echo $news_edit['code'];?>" method="POST" >
							       
					

	<!-- textarea to editor -->
	<h1> <?=$this->lang->line('Georgian');?></h1>
	<input stype="text" name="title_ge" value="<?php echo $news_edit['title_ge'];?>" style="width:100%; height:40px;">
	<br><br>
	<input stype="text" name="short_text_ge" value="<?php echo $news_edit['short_text_ge'];?>" style="width:100%; height:40px;">
	<textarea name="full_text_ge" class="jqte-test"><b><?php echo $news_edit['full_text_ge'];?></u></b></textarea>
		
	<h1> <?=$this->lang->line('Russian');?></h1>
	<input stype="text" name="title_ru" value="<?=$this->lang->line('Title');?>" style="width:100%; height:40px;">
	<br>
	<br>
	<input stype="text" name="short_text_ru" value="<?php echo $news_edit['short_text_ru'];?>" style="width:100%; height:40px;">
	<textarea name="full_text_ru" class="jqte-test"><b><?php echo $news_edit['full_text_ru'];?></b></textarea>
	
	<h1> <?=$this->lang->line('English');?></h1>
	<input stype="text" name="title_en" value="<?=$this->lang->line('Title');?>" style="width:100%; height:40px;">
	<br><br>
	<input stype="text" name="short_text_en" value="<?php echo $news_edit['short_text_en'];?>" style="width:100%; height:40px;">
	<textarea name="full_text_en" class="jqte-test"><b><?php echo $news_edit['full_text_en'];?></b></textarea>
                    ...
                    <div class="box" id="gallery_block">
                        <div class="hotel-listing-form">
                            <form class="text-center" method="POST">
                                ...
                                <div action="<?=base_url('redaqtor/update_news_gallery/')?><?php echo $news_edit['code'];?>" class="dropzone needsclick dz-clickable" id="demo-upload">
...
<div class="container" >
  ...
  <div class="dropdown-content">
      <a href="<?=base_url('redaqtor/set_as_news_main_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Set as main');?></a>
      <a href="<?=base_url('redaqtor/delete_news_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Delete');?></a>
    ...
    <img src="<?=base_url();?>assets/images/news/<?php echo $images_item['file_name']; ?>" style="max-width:100%;max-height:400px;" >
  </div>
  <?php $raod++; ?>
<?php endforeach; ?>
  ...
  <div class="row">
    ...
    <div class="column">
      <img class="demo cursor" src="<?=base_url();?>assets/images/news/<?php echo $imagess_item['file_name']; ?>" style="width:100%;max-height:80px;" onclick="currentSlide(<?php echo $raode; ?>)">
    </div>
   <?php $raode++; ?>
<?php endforeach; ?>
</div>
