...
$(document).ready(function(){
  ...
  $("#mappp").click(function(){
				...
				<div class="in-content-wrapper">
					...
					<div class="box" id="info_block" >
						...
						<div class="hotel-listing-form" id="details_form">
							<form  action="<?=base_url('redaqtor/news_create')?>" method="POST">
	...
	<br><br>
	<input stype="text" name="short_text_ge" value="მოკლე ტექსტი" style="width:100%; height:40px;">
	...
	<br>
	<br>
	<input stype="text" name="short_text_ru" value="მოკლე ტექსტი" style="width:100%; height:40px;">
	...
	<br><br>
	<input stype="text" name="short_text_en" value="მოკლე ტექსტი" style="width:100%; height:40px;">
...
function showSlides(n) {
  ...
  captionText.innerHTML = dots[slideIndex-1].alt;
      ...
      var lngg;
      function initMap() {
        var coord = {lat: <?php echo $news_edit['lat'];?>, lng: <?php echo $news_edit['lng']; ?>};
      ...
      function ganaxleba()
      {
          location.href = "<?=base_url('redaqtor/update_coords/');?><?php echo $news_edit['code'];?>"+"/"+latt+"/"+lngg;
