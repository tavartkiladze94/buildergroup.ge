				...
				<div class="in-content-wrapper">
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								<div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="<?=base_url('redaqtor/index')?>"><?=$this->lang->line('Control panel');?></a>
								</div>
					...
					<div class="box" id="info_block" >
						...
						<div class="hotel-listing-form" id="details_form">
							<form  action="<?=base_url('redaqtor/about_update')?>" method="POST">
							       
					

	<!-- textarea to editor -->
   <h1 style="font-size:50px; color:black;"> <?=$this->lang->line('About us');?></h1>
	<h1> <?=$this->lang->line('Georgian');?></h1>
	<textarea name="about_text_ge" class="jqte-test" style="color:black;"><?php echo $about_text['about_text_ge'];?></textarea>
	<hr>
		<h1> <?=$this->lang->line('Russian');?></h1>
		

	<textarea name="about_text_ru" class="jqte-test"><?php echo $about_text['about_text_ru'];?></textarea>
	<hr>
		<h1> <?=$this->lang->line('English');?></h1>
		

	<textarea name="about_text_en" class="jqte-test"><?php echo $about_text['about_text_en'];?></textarea>
