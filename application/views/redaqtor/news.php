							...
							<div class="dataTables_length" id="example_length" style="width:100%;">
								...
								<table id="example" class="display table-hover table-responsive-xl listing dataTable no-footer" role="grid" aria-describedby="example_info" >
									...
									<tr role="row" class="odd" style="width:100%; height:70px;">
											<td class="sorting_1" ><img src="<?=base_url('assets/images/news/');?><?php echo $news_item['file_name']; ?>" alt="<?=$this->lang->line('Photo');?>" class="img-fluid rounded-circle"  style="width:60px;height:40px;"></td>
											<td ><a href="<?=base_url('redaqtor/news_edit/');?><?php echo $news_item['code']; ?>" style="color:#007bff;"><?php echo $news_item['title_ge']; ?></a></td>
											<td ><a href="<?=base_url('redaqtor/news_edit/');?><?php echo $news_item['code']; ?>" style="color:#007bff;"><?php echo $news_item['date']; ?></a></td>
											<td ><a href="<?=base_url('redaqtor/news_edit/');?><?php echo $news_item['code']; ?>" style="color:#007bff;"><?php echo $news_item['reg_name'] ; ?> <?php echo $news_item['reg_surname'] ; ?></a></td>
											<td ><a href="<?=base_url('redaqtor/news_delete/');?><?php echo $news_item['code']; ?>" style="color:red;"><?php echo $this->lang->line('Delete') ; ?></a></td>
