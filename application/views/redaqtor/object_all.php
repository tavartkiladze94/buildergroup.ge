				...
				<div class="in-content-wrapper">
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								...
								<div class="breadcrumb-item active"><i class="fas fa-angle-right"></i><a href="<?=base_url('redaqtor/apartment_all');?>"><?=$this->lang->line('All');?></a>
								</div>
							</div><!-- End Breadcrumb -->
						</div><!-- End row -->
					</div><!-- End row -->
					...
					<div class="box">
						...
						<div class="hotel-listing-form" id="details_form">
							<form class="text-center" action="<?=base_url('redaqtor/apartment_all_search')?>" method="POST">
							      <div class="form-row">
							      <div class="col-md">
								...
								<div id="example_wrapper" class="dataTables_wrapper no-footer">
								  ...
								  <table id="example" class="display table-hover table-responsive-xl dataTable no-footer" role="grid" aria-describedby="example_info">
									...
									<tr role="row" class="odd">
											...
											<td><a href="<?=base_url('redaqtor/apartment_edit/');?><?php echo $apartment_item['code']; ?>"><?php echo $this->lang->line($apartment_item['category']); ?></a></td>
											<td><a href="<?=base_url('redaqtor/apartment_edit/');?><?php echo $apartment_item['code']; ?>" style="color:#007bff;"><?php echo $this->lang->line($apartment_item['type']); ?></a></td>
