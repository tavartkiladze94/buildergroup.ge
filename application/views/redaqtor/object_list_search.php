...
<div class="col">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								...
								<div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="<?=base_url('redaqtor/apartment_list');?>"><?=$this->lang->line('All');?></a>
								</div>
					...
					<div class="box">
						<div class="row no-gutters">
							<div class="col text-left">
								<div class="add-new">
									<a href="<?=base_url('redaqtor/apartment_create');?>"><?=$this->lang->line('Add new');?><i class="fas fa-plus"></i></a>
								</div><!-- End add-new-->
							</div><!-- End column-->
						...
						<div class="hotel-listing-form" id="details_form">
							<form class="text-center" action="<?=base_url('redaqtor/apartments_list_search')?>" method="POST">
							      <div class="form-row">
							      <div class="col-md">
							...
							<div class="col">
								...
								<table id="example" class="display table-hover table-responsive-xl listing dataTable no-footer" role="grid" aria-describedby="example_info" >
									...
									<tr role="row" class="odd">
											...
											<td><a href="<?=base_url('redaqtor/apartment_view/');?><?php echo $apartment_item['code']; ?>"><?php echo $this->lang->line($apartment_item['category']); ?></a></td>
											<td><a href="<?=base_url('redaqtor/apartment_view/');?><?php echo $apartment_item['code']; ?>" style="color:#007bff;"><?php echo $this->lang->line($apartment_item['type']); ?></a></td>
											<td><a href="<?=base_url('redaqtor/user_view');?>/<?php echo $apartment_item['reg_id']; ?>/<?php echo $apartment_item['reg_name']; ?>/<?php echo $apartment_item['reg_surname']; ?>" style="color:#007bff;"><?php echo $apartment_item['reg_name']; ?></a></td>
											...
											<td>
												<a href="<?=base_url('redaqtor/apartment_view/');?><?php echo $apartment_item['code']; ?>"><i class="fas fa-edit" style="color:#44cc5b;"></i></a>
												<!--<a href="<?=base_url('redaqtor/apartment_delete/');?><?php echo $apartment_item['code']; ?>"><i class="fas fa-trash-alt" ></i></a>-->
											</td>
