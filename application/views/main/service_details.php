...
<html lang="ge">
    <head>
        <meta charset="utf-8">
          <title><?=$this->lang->line('Services');?> - <?php echo $this->lang->line($service_details['type']); ?>  </title>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li >
                                    <a href="<?=base_url('main/services');?>" ><?=$this->lang->line('projects');?></a>
...
<section class="banner_area">
            <div class="container">
                <div class="banner_inner_text">
                    <h4><?php echo $this->lang->line($service_details['type']); ?></h4>
                    <ul>
                        <li><a href="#"><?=$this->lang->line('Home');?></a></li>
                        <li class="active"><a href="#"><?=$this->lang->line('Services');?>/ <?php echo $this->lang->line($service_details['type']); ?></a></li>
                    </ul>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="project_single_inner">
                        ...
                        <div id="slider" class="flexslider">
                            <ul class="slides" >
                                <?php if (!empty($images)) foreach ($images as $images_item): ?>
                                  <li><img src="<?=base_url();?>assets/images/services/<?php echo $images_item['file_name']; ?>" alt="<?php echo $this->lang->line($service_details['object']); ?>" style="max-width:100%;"></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                <?php if (!empty($imagess)) foreach ($imagess as $imagess_item): ?>
                                  <li><img src="<?=base_url();?>assets/images/services/<?php echo $imagess_item['file_name']; ?>" alt="<?php echo $this->lang->line($service_details['object']); ?>"></li>
                                <?php endforeach; ?>
                            </ul>
                    ...
                    <div class="row" style="padding:5px;">
                        <br>
                        <p><?php echo $this->lang->line($service_details['lang']); ?></p>
